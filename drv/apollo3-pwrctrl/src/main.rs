...
//! A driver for the AmbiqMicro Apollo3 Power Control (PWRCTRL).
//!
...
enum Op {
    EnablePeriph = 1, // Enable power for a peripheral.
                      // EnableClock = 1,
                      // DisableClock = 2,
                      // EnterReset = 3,
                      // LeaveReset = 4,
                ...
                match op {
                    Op::EnablePeriph => {
                        if *msg >= 16 {
                            ...
                            let bit: u32 = 1 << msg;
                            // pwrctrl.devpwren.modify(|_, w| w.pwruart0.en());
                            set_bits!(pwrctrl.devpwren, bit)
                            // TODO: checkt DEVPWRSTATUS
                        }
                    }
                }
